/**
Complete the function mergeOptions such that,
 it returns an object which merges the options with the defaultOptions.
 ...
 */
 const mergeOptions = (options, defaultOptions) => {
    const mergedObjects = {...defaultOptions, ...options};
